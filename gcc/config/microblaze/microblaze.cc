...
microblaze_function_prologue (FILE * file)
{
  ...
  /* Get the function name the same way that toplev does before calling
...
/*
  ...
  `varasm', sets a number of commonly-useful bits in SYMBOL_REF_FLAGS. */
...
/* Queue an .ident string in the queue of top-level asm statements.
   ...
   If the front-end is done, we must be being called from toplev.
