		   ...
		   bool speed ATTRIBUTE_UNUSED)
{
  /* The metric to use for the cost-macros is unclear.
     ...
     returning 0, as tree-ssa-loop-ivopts as of r128272 "normalizes"
...
/* Split a 2 word move (DI or presumably DF) into component parts.
   Originally a copy of gen_split_move_double in m32r.  */
		       ...
		       bool frame_related)
{
  ...
  /* Because dwarf2out handles the insns in a parallel as a sequence,
