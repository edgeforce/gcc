...
nvptx_declare_function_name (FILE *file, const char *name, const_tree decl)
{
  ...
  /* For reverse-offload 'nohost' functions: In order to be collectable in
     '$offload_func_table', cf. mkoffload, the function has to be visible. */
...
/* Loop structure of the function.  The entire function is described as
   a NULL loop.  */
/* See also 'gcc/omp-oacc-neuter-broadcast:struct parallel_g'.  */
...
/* See also 'gcc/omp-oacc-neuter-broadcast:omp_sese_split_blocks'.  */
...
/* See also 'gcc/omp-oacc-neuter-broadcast:omp_sese_dump_pars'.  */
...
/* See also 'gcc/omp-oacc-neuter-broadcast:omp_sese_find_par'.  */
...
/* See also 'gcc/omp-oacc-neuter-broadcast:omp_sese_discover_pars'.  */
