...
;; Lengths of several insns are adjusted in avr:adjust_insn_length().
...
;; The code derived from builtins.
...
;; even though its function is identical to that in builtins
