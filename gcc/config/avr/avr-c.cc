...
/* Not included in avr since this requires C front end.  */
...
avr_register_target_pragmas (void)
{
  ...
  /* Register address spaces.  The order must be the same as in the respective
     enum from avr.h (or designated initializers must be used in avr).
...
#error "align this with config.gcc"
  ...
  /* The number of states a DFmode comparison libcall might take and
     reflects what avr:FLOAT_LIB_COMPARE_RETURNS_BOOL returns for
