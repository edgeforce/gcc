...
/* The following are auxiliary macros or structure declarations
   that are used all over the nds32 and nds32.h.  */
...
/* Determine whether we would like to have code generation strictly aligned.
   ...
   Check gcc/common/config/nds32/nds32-common for the optimizations that
   apply -malways-align.  */
...
/* There are 73 vectors in nds32 architecture.
   ...
   We use an array, which is defined in nds32, to record
...
/* Giving A-function and B-function,
   ...
   Please check nds32 implementation for more information.  */
