...
/* `SIZE_TYPE'
   ...
   `init_decl_processing' in the file `c-decl'.  You may not omit
...
/* `BSS_SECTION_ASM_OP'
   ...
   One or more functions to be defined in `varasm'.  These functions
...
/* `REGISTER_PREFIX'
   ...
   `%U', and `%I' options of `asm_fprintf' (see `final').  These are
