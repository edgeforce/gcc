...
; See testcases load-and-test-fp-{1,2}.cc
...
; and those are not handled by Partial Redundancy Elimination (gcse), which
...
;; For SImode and larger, the optabs code will do just fine in
...
; not supposed to be used for immediates (see genpreds).
